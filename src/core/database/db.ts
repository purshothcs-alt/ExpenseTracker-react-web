...
import type {
  Setting, AccountType, Account, TransactionType, Category, Tag,
  Transaction, TransactionTag, RecurringTransaction, BudgetType, Budget,
  BudgetPeriodRecord, GoalType, Goal, GoalContribution, LoanType, Loan,
  LoanRepayment, AssetType, Asset, AssetValuation, Project, ProjectExpense,
  DynamicFieldDefinition, DynamicFieldValue, DashboardWidget, UserDashboardConfig,
  ReportTemplate, AuditLog, IncomeType,
} from './types';
...
export class ExpenseTrackerDB extends Dexie {
  ...
  constructor() {
    ...
    this.version(1).stores({
      ...
      transactions: '++id, transactionDate, accountId, toAccountId, transactionTypeId, categoryId, subCategoryId, projectId, isRecurring',
