...
import type {
  AccountType, Account, TransactionType, Category, Tag,
  GoalType, Goal, GoalContribution, LoanType, Loan, LoanRepayment,
  AssetType, Asset, AssetValuation, Project, ProjectExpense,
  DynamicFieldDefinition, DynamicFieldValue, DashboardWidget,
  UserDashboardConfig, ReportTemplate, BudgetType, Budget,
  BudgetPeriodRecord, IncomeType, RecurringTransaction,
} from '../types';
...
export const transactionTypeRepo = new BaseRepository<TransactionType>(db.transactionTypes as never);
...
export const goalContributionRepo = new BaseRepository<GoalContribution>(db.goalContributions as never);
...
export const dynamicFieldDefRepo = new BaseRepository<DynamicFieldDefinition>(db.dynamicFieldDefinitions as never);
export const dynamicFieldValueRepo = new BaseRepository<DynamicFieldValue>(db.dynamicFieldValues as never);
export const dashboardWidgetRepo = new BaseRepository<DashboardWidget>(db.dashboardWidgets as never);
export const userDashboardConfigRepo = new BaseRepository<UserDashboardConfig>(db.userDashboardConfig as never);
...
export const recurringTransactionRepo = new BaseRepository<RecurringTransaction>(db.recurringTransactions as never);
